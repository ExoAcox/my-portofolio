...
const experiences = [{
    ...
    {
        label: "SIIS",
        href: "https://siis.udata.id/"
    },
    {
        label: "SIIS CMS",
        href: "https://cmsconfig-stg.mygears.io/"
    },
    {
        label: "GEARS",
    ...
    "desc": "Completed an intensive bootcamp program focused on full-stack technologies (React & Node.js) and best practices in modern web development. Built responsive and dynamic applications while collaborating in team-based projects.",
    "date": "2020",
    "links": []
},
]
